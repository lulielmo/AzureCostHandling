...
class AzureCostProcessor:
    ...
    def generate_konteringsrader(self, df, config):
        ...
        kolumner = [
            "Kon/Proj", "_empty1", "RG", "Aktivitet", "ProjAkt", "EAN", "ProjKat", "_empty2", "Netto", "Godkänt av", "KommentarBeskrivning"
        ]
    ...
    def export_to_excel(self, df, filename=None):
        ...
        with pd.ExcelWriter(filename, engine='xlsxwriter') as writer:
            ...
            headers = ["Kon/Proj", "", "RG", "Aktivitet", "ProjAkt", "EAN", "ProjKat", "", "Netto", "Godkänt av"]
